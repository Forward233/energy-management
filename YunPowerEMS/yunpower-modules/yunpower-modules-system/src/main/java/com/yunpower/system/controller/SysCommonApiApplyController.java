 ...
 * @date 2023-10-07
 */
@Tag(name = "D 第三方接入申请表", description = "D 第三方接入申请表")
@RestController
...
public class SysCommonApiApplyController extends BaseController {
     ...
     * 获取第三方接入申请详细信息
     */
    @Operation(summary = "获取第三方接入申请详细信息")
