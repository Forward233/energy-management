package com.yunpower.job.controller;

import java.util.List;
import jakarta.servlet.http.HttpServletResponse;

import com.yunpower.job.domain.SysJob;
import com.yunpower.job.util.ScheduleUtils;
...
import com.yunpower.common.core.exception.job.TaskException;
...
import com.yunpower.job.service.ISysJobService;
import com.yunpower.job.util.CronUtils;
...
public class SysJobController extends BaseController
{
     ...
     * 查询定时任务列表
     */
    @ApiOperation("查询定时任务列表") //Knife4j接口文档
