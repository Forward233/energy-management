...
import com.yunpower.common.core.constant.TokenConstants;
...
public class SecurityUtils {
    ...
    public static String getNickName() {
        ...
        return loginUser == null ? "" : loginUser.getSysUser().getNickName();
    }
     ...
     * 获取用户管理员标志
     */
    public static Integer getUserSupper() {
        LoginUser loginUser = SecurityContextHolder.get(SecurityConstants.LOGIN_USER, LoginUser.class);
        return loginUser == null ? 0 : loginUser.getSysUser().getIsSupper();
    }
    ...
    //{
    //    String isSupper = SecurityContextHolder.getUserSupper();
    //    return "1".equals(isSupper);
    //}
