...
public class ReportTemplates extends BaseEntity {
     ...
     * 报表类型（1普通 2峰谷）
     */
    @Schema(description = "报表类型（1普通 2峰谷）")
     ...
     * 可见类型（1公有 2私有）
     */
    @Schema(description = "可见类型（0默认 1公有 2私有）")
     ...
     * 表头配置
     */
    @Schema(description = "表头配置，json格式 [{deviceId:xxx,deviceVarId:xxx,deviceVarName:xxx}]")
    @Excel(name = "表头配置")
     ...
     * 系统默认（0系统 1自定义）
     */
    @Schema(description = "系统默认（0系统 1自定义）")
