...
public class FeignMonitorDevice extends BaseEntity {
    private static final long serialVersionUID = -600426923382808964L;
    ...
    @Excel(name = "电能质量分析", readConverterExp = "0=否,1=是")
     ...
     * 子列表
     */
    List<FeignMonitorDevice> children = new ArrayList<>();
